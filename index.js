...
const { startWedServer } = require("./web/server");
const loaCommand = require("./commands/wed/loa");
const { initWedDatabase } = require("./utils/wedStorage");
...
client.commands.set("loa", loaCommand);

client.once("clientReady", async () => {
    try {
        await initDatabase();
        await initWedDatabase();
        startWedServer(client);
